...
const TokenUNO: FC<InnerLogoProps> = ({ size }) => (
  ...
  >
    <g clipPath="url(#clip0_2551_18397)">
      <path
        d="M28 0C43.4654 0 56 12.5371 56 28C56 43.4654 43.4654 56 28 56C12.5371 56 0 43.4641 0 28C0 12.5371 12.5371 0 28 0Z"
        fill="#0C66E4"
      />
      <path fillRule="evenodd" clipRule="evenodd" d="M42.875 32.375H13.125V28H42.875V32.375Z" fill="white" />
      <path fillRule="evenodd" clipRule="evenodd" d="M42.875 25.375H13.125V21H42.875V25.375Z" fill="white" />
      <path
